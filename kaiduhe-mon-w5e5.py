...
cfg.PATHS['working_dir'] = utils.gettempdir(dirname='/home/public/sch005506/OGGM/cn', reset=True)
print(f"Working directory: {cfg.PATHS['working_dir']}")

# Read RGI IDs
with open('/home/public/sch005506/OGGM/rgi_ids2.txt', 'r') as f:
    rgi_ids = [line.strip() for line in f if line.strip()]

# Set output path
save_path = '/home/public/sch005506/OGGM/testrunoff-mon-w5e5/'
...
for gdir in gdirs:
    try:
        ...
        if centerline_records:
            # Do something with centerline_records
...
for gdir in calibrated_gdirs:
    ...
    try:
        ...
        runoff_vars = ['melt_off_glacier_monthly', 'melt_on_glacier_monthly',
